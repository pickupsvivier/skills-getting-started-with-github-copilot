document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear existing activity UI and options
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        if (details.participants.length) {
          ...
          emptyParagraph.className = "no-participants";
          emptyParagraph.textContent = "No participants yet.";
          participantsDiv.appendChild(emptyParagraph);
        }
